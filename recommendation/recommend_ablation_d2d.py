...
# 假设的文件路径（请替换为实际的文件路径）
# file_path1 = "/root/data/movie/data.csv"
# file_path2 = "/root/data/music/data.csv"
# path2 = '/root/code/DiffCDR-main/data/ready/_5_5/tgt_CDs_and_Vinyl_src_Movies_and_TV/'

file_path1 = "/root/data/book/data.csv"
file_path2 = "/root/data/movie/data.csv"
path2 = '/root/code/DiffCDR-main/data/ready/_5_5/tgt_Movies_and_TV_src_Books/'

# file_path1 = "/root/data/book/data.csv"
# file_path2 = "/root/data/music/data.csv"
# path2 = '/root/code/DiffCDR-main/data/ready/_5_5/tgt_CDs_and_Vinyl_src_Books/'
    ...
    for t in [0]:
        for T in [5]:
            for hidden_dims in [[embedding_dim*2]]:
                ...
                best_mae, best_rmse, best_epoch, best_model_state = diff.train_d2d(diff_model, target_only_dataloader_d2d, overlap_dataloader_d2d, 
                                                                 test_loader_d2d1, overlap_dataloader, target_only_dataloader, 
                                        epochs=epochs, lr=diff_lr, weight_decay=weight_decay, non_overlap_weight = non_overlap_weight)
                diff_model.load_state_dict(best_model_state)
                result = mlp_model.test_model(model, diff_model, test_loader_d2d1)
